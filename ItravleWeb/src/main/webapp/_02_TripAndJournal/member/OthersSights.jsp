...
<%
	...
	List<SightVO> sightVO = sightService.selectByType("sight_type01");
	...
	$("tr.sightId>td:nth-child(9)").each(function(){
 		$(this).click(function(){
				...
				var stylei=' width="98%" height="98%"  frameborder="0" scrolling="auto"';
 				$("#dialog-other").html('<iframe src="'+uri+sightId+'"'+stylei+'></iframe>');
 				dialog.dialog( "open" );
				closedialog = 0;
 		});
 	});
