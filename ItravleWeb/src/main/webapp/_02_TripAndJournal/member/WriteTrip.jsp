		...
		<div id="right">
			...
			<div id="sightsTabs">
				...
				<div id="tabs-1">
					...
					<c:forEach var="sightVO" items="${sightVO}" varStatus="vs">
						<table class="sight">
							<tr>
						...
						<form action="<c:url value="/_02_TripAndJournal/member/WriteTrip.controller" />" method="post">
							...
							<P />
							<input type="hidden" name="tripOrder" value=1>
							<P />
							<!-- 先寫死 -->
							<input type="hidden" name="stayTime" value="${sightVO.spendHour}">
							<P />
							<input type="hidden" name="whichDay" value=1>
							<P />
							<!-- 先寫死 -->
							<input type="hidden" name="referenceType" value="type_id01">
							<P />
							<input type="hidden" name="sightId" value="${sightVO.sightId}">
							<p />
							<input type="hidden" name="notes" value="test notes">
							<p />
							<!-- 先寫死 -->
							<input type="hidden" name="sightBudget" value=100.0>
							<p />
							<!-- 先寫死 -->
