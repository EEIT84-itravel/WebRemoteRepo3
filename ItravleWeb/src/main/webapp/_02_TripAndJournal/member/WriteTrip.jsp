...
<body>
	...
	<article>
		...
		<div id="right">
			...
			<tr>
			<td>
				<input type="button" value="我的收藏" name="my collection">
				<input type="button" value="娛樂" name="amusement">
				<input type="button" value="購物" name="shopping">
				<input type="button" value="美食" name="food">
				<input type="button" value="住宿" name="hotel">
				<input type="button" value="其他" name="others">
			</td>
			</tr>
			</table>
