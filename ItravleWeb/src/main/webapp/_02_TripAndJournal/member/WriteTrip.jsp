			...
			<div id="left">
				<table>
					<tr>
						...
						<td id="topButton"><input type="button" value="預算一覽"
							name="budget"> <input type="button" value="下載旅遊書"
							name="download travel book"> <input type="button"
							value="旅伴" name="partner"> <input type="button"
							value="儲存" name="store"> <input type="button" value="發布"
							name="publish"></td>
					</tr>
				</table>
				<div id="days">
				...
				<div id="trip">
					<div id="tripBut">
						<span>主要交通方式：${tripVO.transFormId}</span> <span><input
							...
							type="button" value="顯示筆記" name="show notes"></span> <span><input
