	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li><a href="<c:url value="/_01_Sight/SightIndex.controller?action=selectAll"/>">看景點</a></li>							
      		    ...
      		    <li class="dropdown">
          				...
          				<ul class="dropdown-menu" role="menu">
          				     ...
          				     <li><a href="<c:url value="/_05_Member/member/MemberTrip.jsp" />">我的行程</a></li>
           					 ...
           					 <li><a href="<c:url value="/_05_Member/member/MemberForum.jsp" />">我的討論區</a></li>
           					 ...
           					 <li><a href="<c:url value="/_05_Member/member/MemberCollectionForum.jsp" />">我的收藏討論區</a></li>
