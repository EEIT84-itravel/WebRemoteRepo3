	...
	<form action="<c:url value="/_04_Forum/member/WritingsServlet.controller"/>"
		...
		<input type="hidden" name="crud" value="${crud}">
			<table>
				...
				<tr>
					<td><input type="submit" value="確定發表" onclick="if(confirm('您確定發表新文章嗎?')) return true;else return false"></td>
				</tr>
			</table>
		</div>
	</form>
=======
	...
	<article>
		<form action="<c:url value="/_04_Forum/member/Article.controller"/>" method="post">
			<div id="header">
				<table>
					<c:import url="/_04_Forum/ForumHead.jsp"></c:import>
					<tr>
