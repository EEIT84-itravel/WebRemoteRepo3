...
<body>
	<form
		action="<c:url value="/_06_BeckEnd/beckend/NewEvent.controller" />">
		<table>
			<tr>
				<td>活動名稱：</td>
				<td><input type="text" name="eventTopic"
					value="${param.eventTopic}"></td>
				<td><span class="error">${error.eventTopic}</span></td>
			</tr>
			<tr>
				<td>活動圖片：</td>
				<td><input type="file" name="eventPhoto"
					value="${param.eventPhoto}"size="20"></td>
				<td><span class="error">${error.eventPhoto}</span></td>
			</tr>
			<tr>
				<td>活動內容：</td>
				<td><textarea rows="5" cols="40" name="eventContent"
						value="${param.eventContent}"></textarea></td>
				<td><span class="error">${error.eventContent}</span></td>
			</tr>
			<tr>
				<td>活動開始時間：</td>
				<td><input type="text" id="eventStartDate"
					name="eventStartDate" value="${param.eventStartDate}"></td>
				<td><span class="error">${error.eventStartDate}</span></td>
			</tr>
			<tr>
				<td>活動結束時間：</td>
				<td><input type="text" id="eventEndDate" name="eventEndDate"
					value="${param.eventEndDate}"></td>
