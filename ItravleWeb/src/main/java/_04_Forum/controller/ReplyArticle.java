...
@WebServlet("/_04_Forum/member/ReplyArticle")
...
//		}
		if (error != null && !error.isEmpty()) {
			request.getRequestDispatcher("/_04_Forum/member/Reply.jsp").forward(
					request, response);
			return;
		} else {
			request.getRequestDispatcher("/_04_Forum/LookArticle.jsp")
