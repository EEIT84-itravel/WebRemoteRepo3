...
@WebServlet("/_05_Member/member/deljournal.controller")
public class DeleteJournalCollectionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//處理資料
				...
				response.sendRedirect(path+"/_05_Member/member/MemberCollectionJournal.jsp");
				 return;
	}
