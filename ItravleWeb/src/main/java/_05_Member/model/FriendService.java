...
//		ArrayList list = service.findFriend(2);
//		System.out.println(list);
//		ArrayList list1 = service.findNotFriend(2);
//		System.out.println(list1);
//		Boolean a = service.newFriend(1,4);
//		System.out.println(a);
//		Boolean b = service.updateBadFriendToNew(1,4);
//		System.out.println(b);
//		Boolean a = service.newBadFriend(2,3);
//		System.out.println(a);
//		ArrayList list2 = service.findEachOtherFriend(1);
//		Boolean b = service.delFriend(1, 5);
//		Boolean b = service.delBadFriend(2,4);
//		System.out.println(b);
//		Set<Integer> list1 = service.FindNotyetFriend(1);
//		System.out.println(list1);
//		Set<Integer> list2 = service.findNotyetFriendByMe(1);
//		System.out.println(list2);
	...
	public Boolean updateBadFriendToNew(Integer memberId,Integer friendId){ //將黑名單改為好友
		...
		List<FriendVO> list = friendDAO.selectbyMemberIdAndFriendId(memberId,friendId);
		...
		List<FriendVO> listafter = friendDAO.selectbyMemberIdAndFriendId(memberId,friendId);
	...
	public ArrayList<Integer> findEachOtherFriend(Integer memberId){
		...
		if(friendlist2.size()>friendlist.size() || friendlist2.size() == friendlist.size()){//開始比對
		...
		}else{for(int i =0;i<friendlist.size();i++){
